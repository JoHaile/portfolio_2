...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "AI-assisted brain MRI screening and image-classification web application. Developed a web interface for analyzing brain MRI scans and identifying potential abnormalities using pretrained convolutional neural network (CNN) models.",
    highlights: [
    ...
    techStack: ["Python", "CNNs", "Next.js", "React", "REST APIs", "Tailwind CSS"],
  },
  {
    category: "AI & EdTech",
    status: "Featured AI Project",
    ...
    techStack: ["Next.js", "TypeScript", "LLM Integration", "Python", "Node.js"],
  },
  {
    ...
    description:
      "Full-stack pharmacy management & delivery platform built with the Next.js ecosystem. Developed an operations dashboard for inventory, order processing, and delivery management with secure Better Auth authentication and Prisma relational layer.",
    highlights: [
