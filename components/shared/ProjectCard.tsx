...
function ProjectCard({
  ...
  return (
    ...
    >
      ...
      <h3 className="mt-3 px-6 text-2xl font-bold leading-tight tracking-[-0.02em] text-cream-foreground">
        {title}
      </h3>
      ...
      <div className="mt-auto flex items-end justify-between px-6 pb-6 pt-5">
        ...
        <span className="group/btn inline-flex cursor-pointer items-center gap-1.5 rounded-xl bg-cream-foreground px-4 py-2 text-xs font-medium text-cream transition-all duration-200 hover:-translate-y-0.5 hover:bg-cream-foreground/90 hover:shadow-md">
          View
